...
//       {/* Navigation */}
//       <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-gray-900/80 border-b border-orange-500/20">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="flex justify-between items-center h-16">
//             <div className="flex items-center space-x-2">
//               <div className="w-8 h-8 backdrop-blur-sm bg-gray-800/80 rounded-lg flex items-center justify-center border border-orange-500/30 shadow-lg shadow-orange-500/20">
...
//                 </button>
//                 <div className="absolute top-full left-0 mt-2 w-64 backdrop-blur-xl bg-gray-800/95 border border-orange-500/30 rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 shadow-2xl shadow-orange-500/20">
//                   <div className="p-2">
//                     <a
//                       href="/mindhack-2025"
...
//                 className="md:hidden backdrop-blur-xl bg-gray-800/90 border-t border-orange-500/20 overflow-hidden"
//               >
//                 <motion.div
//                   initial={{ y: -20 }}
//                   animate={{ y: 0 }}
...
//             </div>
//             <h1
//               className="text-4xl md:text-6xl font-bold text-white mb-4 glow-text-strong"
//               style={{ fontFamily: "Orbitron, sans-serif" }}
//             >
//               MIND HACK{" "}
...
//             </h1>
//             <h2
//               className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent mb-6 glow-text-gradient"
//               style={{ fontFamily: "Orbitron, sans-serif" }}
//             >
//               Ancient Revival
//             </h2>
...
//                 amount: "$10,000",
//                 desc: "First place in each competition category",
...
//                 amount: "$5,000",
//                 desc: "Innovation and impact awards",
...
//               >
//                 <div
//                   className={`backdrop-blur-xl bg-gray-800/40 border ${award.borderColor} hover:bg-gray-700/50 transition-all duration-500 group-hover:scale-105 h-full relative overflow-hidden rounded-2xl hover:shadow-2xl ${award.glowColor}`}
//                 >
//                   <div
...
//                     <div
//                       className={`w-20 h-20 bg-gray-800/60 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 border ${award.borderColor} hover:shadow-lg ${award.glowColor}`}
//                     >
...
//                     </h3>
//                     <div
//                       className={`text-3xl font-bold ${award.color} mb-4`}
//                       style={{ fontFamily: "Orbitron, sans-serif" }}
//                     >
//                       {award.amount}
//                     </div>
...
//       <section className="py-24 px-4 bg-gray-800 relative">
//         <div className="max-w-7xl mx-auto">
//           <div className="text-center mb-16">
//             <motion.h2
//               initial={{ y: 50, opacity: 0 }}
...
//                 tools: ["Blender", "AutoCAD", "Fusion 360", "Maya"],
...
//                 tools: ["Scratch", "App Inventor", "Blockly", "Snap!"],
...
//                 tools: ["Arduino", "Raspberry Pi", "Sensors", "Motors"],
...
//                       <div
//                         className={`w-16 h-16 rounded-2xl bg-gray-800/50 backdrop-blur-sm border ${category.borderColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 hover:shadow-lg ${category.glowColor}`}
//                       >
//                         <category.icon
...
//                     {/* Content */}
//                     <h3
//                       className="text-2xl font-bold text-white mb-4 group-hover:text-orange-400 transition-colors duration-300"
//                       style={{ fontFamily: "Orbitron, sans-serif" }}
//                     >
//                       {category.title}
//                     </h3>
...
//                       <button
//                         className={`w-full py-3 px-4 rounded-xl bg-gray-800/50 backdrop-blur-sm border ${category.borderColor} text-white font-semibold hover:bg-gray-700/50 transition-all duration-300 flex items-center justify-center space-x-2 hover:shadow-lg ${category.glowColor}`}
//                       >
...
//               >
//                 <div
//                   className={`backdrop-blur-xl bg-gray-800/40 border ${group.borderColor} hover:bg-gray-700/50 transition-all duration-500 group-hover:scale-105 h-full relative overflow-hidden rounded-2xl hover:shadow-2xl ${group.glowColor}`}
//                 >
//                   <div
...
//                   <div className="p-8 text-center h-full flex flex-col relative z-10">
//                     <div
//                       className={`w-20 h-20 bg-gray-800/60 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 border ${group.borderColor} hover:shadow-lg ${group.glowColor}`}
//                     >
...
//                     </h3>
//                     <div
//                       className={`text-xl font-bold ${group.color} mb-4`}
//                       style={{ fontFamily: "Orbitron, sans-serif" }}
//                     >
//                       {group.age}
//                     </div>
...
//                 desc: "Originality, creativity, and novel approaches to problem-solving.",
//                 color: "text-yellow-400",
...
//                 percentage: 40,
//                 subtitle: "Complexity",
//                 desc: "Technical skill, code quality, and sophisticated implementation.",
//                 color: "text-orange-400",
...
//                 desc: "Presentation quality, user experience, and real-world impact potential.",
//                 color: "text-amber-400",
...
//                 transition={{ duration: 0.6, delay: index * 0.2 }}
//                 viewport={{ once: false }}
//                 className={`backdrop-blur-xl bg-gray-800/40 border border-orange-500/20 rounded-2xl p-8 hover:shadow-2xl ${criteria.glowColor} transition-all duration-500`}
//               >
//                 <div className="text-center mb-6">
//                   <div
//                     className={`w-16 h-16 bg-gray-800/60 backdrop-blur-sm rounded-xl flex items-center justify-center mx-auto mb-4 border border-orange-500/20 hover:shadow-lg ${criteria.glowColor}`}
//                   >
//                     <criteria.icon className={`h-8 w-8 ${criteria.color}`} />
//                   </div>
//                   <h3
//                     className="text-2xl font-bold text-white mb-2"
//                     style={{ fontFamily: "Orbitron, sans-serif" }}
...
//                   </h3>
//                   <div
//                     className={`text-3xl font-bold ${criteria.color} mb-2`}
//                     style={{ fontFamily: "Orbitron, sans-serif" }}
//                   >
//                     {criteria.percentage}%
//                   </div>
...
//                 <div className="mb-6">
//                   <div className="w-full bg-gray-700/50 rounded-full h-3 border border-orange-500/20">
//                     <motion.div
//                       initial={{ width: 0 }}
//                       whileInView={{ width: `${criteria.percentage}%` }}
//                       transition={{ duration: 1.5, delay: index * 0.3 }}
//                       viewport={{ once: false }}
//                       className={`h-full ${criteria.bgColor} rounded-full relative overflow-hidden shadow-lg ${criteria.glowColor}`}
//                     >
...
//             >
//               <h2
//                 className="text-4xl font-bold text-white mb-8 glow-text-strong"
//                 style={{ fontFamily: "Orbitron, sans-serif" }}
//               >
//                 Key{" "}
...
//                     viewport={{ once: false }}
//                     className="flex items-center space-x-4 p-4 backdrop-blur-xl bg-gray-800/40 border border-orange-500/20 rounded-lg hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-300"
//                   >
//                     <div className="w-12 h-12 bg-gray-800/60 backdrop-blur-sm rounded-lg flex items-center justify-center border border-orange-500/20 shadow-lg shadow-orange-500/20">
...
//                 </span>
//               </h2>
//               <div className="backdrop-blur-xl bg-gray-800/40 border border-orange-500/20 rounded-2xl p-6 mb-6 hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-300">
...
//               {/* Real Google Map */}
//               <div className="backdrop-blur-xl bg-gray-800/40 border border-orange-500/20 rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300">
//                 <a
//                   href="https://www.google.com/maps?q=16.8409,96.1735"
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="block relative group"
//                 >
//                   <div className="h-64 bg-gray-700/50 relative overflow-hidden">
...
//                     {/* Fallback content */}
//                     <div
//                       className="absolute inset-0 bg-gray-700/50 flex items-center justify-center"
//                       style={{ display: "none" }}
//                     >
...
//                     </div>
//                     {/* Overlay */}
//                     <div className="absolute inset-0 bg-gray-900/20 group-hover:bg-gray-900/10 transition-colors duration-300 flex items-center justify-center">
...
//       <section className="py-24 bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 relative overflow-hidden">
...
//               >
//                 <div className="w-20 h-20 bg-gray-800/60 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 border border-orange-500/20 hover:shadow-lg hover:shadow-orange-500/20">
...
//                 transition={{ duration: 0.6, delay: index * 0.2 }}
//                 viewport={{ once: false }}
//                 className="backdrop-blur-xl bg-gray-800/40 border border-orange-500/20 rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-500"
//               >
...
//           >
//             <h2
//               className="text-4xl md:text-6xl font-bold text-white mb-8 glow-text-strong"
//               style={{ fontFamily: "Orbitron, sans-serif" }}
//             >
//               Ready to Join{" "}
//               <span className="text-orange-400 glow-text-orange">
...
//                 transition={{ duration: 0.6, delay: index * 0.1 }}
//                 viewport={{ once: false }}
//                 className="backdrop-blur-xl bg-gray-800/40 border border-orange-500/20 rounded-lg p-6 text-center hover:bg-gray-700/50 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20"
//               >
//                 <div className="w-16 h-16 bg-gray-800/60 backdrop-blur-sm rounded-lg flex items-center justify-center mx-auto mb-4 border border-orange-500/20 shadow-lg shadow-orange-500/20">
...
//           <div className="text-center">
//             <button className="backdrop-blur-sm bg-gray-800/50 hover:bg-gray-700/60 text-white font-bold px-12 py-4 text-lg border border-orange-500/20 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20">
//               Become a Partner
//             </button>
//           </div>
//         </div>
...
//       {/* Footer */}
//       <footer className="backdrop-blur-xl bg-gray-800/20 border-t border-orange-500/20 py-16 px-4">
//         <div className="max-w-7xl mx-auto">
//           <motion.div
//             initial={{ y: 50, opacity: 0 }}
//             whileInView={{ y: 0, opacity: 1 }}
...
//                 <div className="w-10 h-10 backdrop-blur-sm bg-gray-800/50 rounded-lg flex items-center justify-center border border-orange-500/20 shadow-lg shadow-orange-500/20">
