...
export default function FAQ() {
  ...
  const faqCategories = {
    ...
    other: {
      ...
      faqs: [
        {
          question: "Can I participate if I'm not from Myanmar?",
          answer:
            "Absolutely! MindHack 2025 welcomes international participants. We provide virtual participation options and can assist with travel arrangements for in-person attendance. All materials and communication are available in English.",
        },
        {
          question: "What programming experience do I need?",
          answer:
            "No prior programming experience is required! MindHack is designed for all skill levels. We provide beginner-friendly workshops, tutorials, and mentorship. Whether you're a complete beginner or an experienced coder, there's a place for you.",
        },
        {
          question: "Are there any prizes for participation?",
          answer:
            "Yes! All participants receive certificates of participation. Winners in each category receive cash prizes, tech gadgets, scholarships, and internship opportunities with our partner companies. Special recognition awards are also given for innovation and creativity.",
        },
        {
          question: "Can I change my project idea after registration?",
          answer:
            "Yes, you can modify or completely change your project idea up until the competition begins. We encourage participants to explore different ideas and find what excites them most. Just notify us through your participant portal.",
        },
        {
          question: "What happens if I miss the registration deadline?",
          answer:
            "While we encourage early registration, we may accept late registrations on a case-by-case basis if space permits. Contact our support team immediately if you've missed the deadline. We also maintain a waitlist for last-minute openings.",
        },
      ],
    },
  };
